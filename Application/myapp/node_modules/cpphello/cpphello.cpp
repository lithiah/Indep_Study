...
void Clusters::setupClusters() {
    //assign inital clusters based on first n data points
...
//run the clusters algorithm sequentially/NOT in parallel
...
//format cluster assignments output so that we can pass it back to javascript
...
//must convert this local array to a vector because v8 doesn't allow parallel accessing of local arrays
...
//get all the values from javascript (they're in args) and run clusters sequentially
...
//get all the values from javascript (they're in args) and run clusters in parallel with 1 thread
...
//get all the values from javascript (they're in args) and run clusters in parallel with 2 threads
...
//get all the values from javascript (they're in args) and run clusters in parallel with 4 threads
...
//get all the values from javascript (they're in args) and run clusters in parallel with 8 threads
...
//set the names of javascript method calls for corresponding C++ functions
...
//assign name of module and what method sets targets
